...
$dom->parse( Mojo::Asset::File->new( path => $cache_file )->slurp );
like( $dom->at('b')->text, qr/cd/, "It has bold html element in the cached html file" );
...
$dom->parse( Mojo::Asset::File->new( path => $cache_file )->slurp );
like( $dom->at('b')->text, qr/dvd/, "It has bold html element in the cached html file" );
...
$dom->parse( Mojo::Asset::File->new( path => $cache_file )->slurp );
like( $dom->at('h1')->text, qr/13/, " It has h1 html element in the cached html file " );
